...
/**
 * FileexistsResponse Class Doc Comment
 *
 * @category Class
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FileexistsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FileexistsResponse';
     ...
     * Sets result
     *
     * @param string $result whether success or failure
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message 0 means the file does not exist, 1 means the file exists
     *
     * @return $this
     */
