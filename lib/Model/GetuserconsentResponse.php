...
/**
 * GetuserconsentResponse Class Doc Comment
 *
 * @category Class
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetuserconsentResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetuserconsentResponse';
     ...
     * Sets showdialog
     *
     * @param string $showdialog 1 - show user consent dialog, 0 - do not show the dialog
     *
     * @return $this
     */
     ...
     * Sets consent
     *
     * @param string $consent user consent message
     *
     * @return $this
     */
