...
/**
 * GetmostactivesharesResponse Class Doc Comment
 *
 * @category Class
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetmostactivesharesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetmostactivesharesResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accesspath'] === null) {
            $invalidProperties[] = "'accesspath' can't be null";
        }
        if ($this->container['lastaccess'] === null) {
            $invalidProperties[] = "'lastaccess' can't be null";
        }
