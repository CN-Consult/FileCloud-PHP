 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FileinfoResponse implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['showquickedit'] === null) {
            $invalid_properties[] = "'showquickedit' can't be null";
        }
        if ($this->container['showlockunlock'] === null) {
            $invalid_properties[] = "'showlockunlock' can't be null";
        }
        if ($this->container['showshareoption'] === null) {
            $invalid_properties[] = "'showshareoption' can't be null";
        }
