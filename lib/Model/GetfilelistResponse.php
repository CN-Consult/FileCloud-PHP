 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetfilelistResponse implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['isroot'] === null) {
            $invalid_properties[] = "'isroot' can't be null";
        }
        if ($this->container['issyncable'] === null) {
            $invalid_properties[] = "'issyncable' can't be null";
        }
        if ($this->container['isshared'] === null) {
            $invalid_properties[] = "'isshared' can't be null";
        }
