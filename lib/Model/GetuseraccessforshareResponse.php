...
/**
 * GetuseraccessforshareResponse Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetuseraccessforshareResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GetuseraccessforshareResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ispublic'] === null) {
            $invalid_properties[] = "'ispublic' can't be null";
        }
    ...
    /**
     * Sets ispublic
     * @param string $ispublic is the share public or not
     * @return $this
     */
