...
/**
 * RequestdeviceaccessResponse Class Doc Comment
 *
 * @category Class
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RequestdeviceaccessResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestdeviceaccessResponse';
     ...
     * Sets result
     *
     * @param string $result 0 : api failed, 1 : request access pending user approval, 2 : request access pending admin approval
     *
     * @return $this
     */
