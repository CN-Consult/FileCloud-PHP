...
/**
 * GetemailsubjectResponse Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetemailsubjectResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GetemailsubjectResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['param'] === null) {
            $invalid_properties[] = "'param' can't be null";
        }
    ...
    /**
     * Sets param
     * @param string $param email template name
     * @return $this
     */
