...
/**
 * GetfavoritesinnamedlistResponse Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetfavoritesinnamedlistResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GetfavoritesinnamedlistResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['modifiedepoch'] === null) {
            $invalid_properties[] = "'modifiedepoch' can't be null";
        }
        if ($this->container['type'] === null) {
            $invalid_properties[] = "'type' can't be null";
        }
        if ($this->container['favoritelistid'] === null) {
            $invalid_properties[] = "'favoritelistid' can't be null";
        }
